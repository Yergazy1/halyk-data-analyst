...
# Заголовки
headers = [
    "Исполнитель", "Ключ задачи", "Создатель", "Статус", 
    "Открыто", "В работе", "Тестирование", "Готово", 
    "Перенесем в Спринт 3", "Из релиза"
]
worksheet.insert_row(headers, index=1)

url = f"{JIRA_URL}/rest/agile/1.0/sprint/{SPRINT_ID}/issue"
params = {
    "fields": "key,assignee,creator,status,created,customfield_11400",
    "expand": "changelog"
}
...
while True:
    ...
    if response.status_code == 200:
        ...
        for issue in issues:
            ...
            custom_field_value = "Да" if fields.get("customfield_11400") else "Нет"
            ...
            rows_to_insert.append([
                ...
                transfer_status, custom_field_value  # Заполняем "Да", если поле не пустое
            ])
